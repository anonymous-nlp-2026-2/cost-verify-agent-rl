...
CHECKPOINT = "./checkpoints/exp029_hf"
MAX_TURNS = 50
TEMPERATURE = 0.4
...
def main():
    ...
    print("\n" + "="*80)
    print("Per-Task-Type Breakdown (exp029 seed1, 134 OOD)")
    print("="*80)
    ...
    save_path = "/data/tmp/exp029_per_task_type_breakdown_t04.json"
