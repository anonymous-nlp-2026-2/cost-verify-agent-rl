#!/bin/bash
# exp019b_expert_sft_v3: second-stage SFT from exp008_sft on format-fixed expert data.
...
TRAIN_DATA="/data/expert_sft_v3/expert_sft_train.jsonl"
VAL_DATA="/data/expert_sft_v3/expert_sft_val.jsonl"
OUTPUT_DIR="./checkpoints/exp019b_expert_sft_v3"
LOG_FILE="./logs/exp019b_expert_sft_v3.log"
