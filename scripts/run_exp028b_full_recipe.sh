...
# exp028b: Recipe Gap — Full GiGPO Recipe Alignment
# 全面对齐参考论文参数: LR=1e-6, KL=0.01, mini_batch=32(暂保持), steps=150

echo "=== [PRE-FLIGHT] exp028b: full recipe alignment ==="
...
# --- Config file ---
CONFIG_FILE="./RAGEN/config/_alfworld_exp028b_full_recipe.yaml"
...
export WANDB_NAME=exp028b_full_recipe
...
cd ./RAGEN
python train.py --config-name _alfworld_exp028b_full_recipe 2>&1 | tee ~/runs/cost-verify-agent-rl/exp028b_full_recipe.log
