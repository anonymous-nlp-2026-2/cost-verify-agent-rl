...
# exp028a: Penalty Verification (Control Group) — GPU 0
# ppo_mini_batch_size=8, invalid_action_penalty_coef=0.1

echo "=== [PRE-FLIGHT] exp028a: penalty verification (GPU 0) ==="
...
# --- Config file ---
CONFIG_FILE="./RAGEN/config/_alfworld_exp028a_penalty.yaml"
...
export WANDB_NAME=exp028a_penalty
...
cd ./RAGEN
python train.py --config-name _alfworld_exp028a_penalty 2>&1 | tee ~/runs/cost-verify-agent-rl/exp028a_penalty.log
