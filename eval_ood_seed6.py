...
CHECKPOINT = "./checkpoints/qwen_seed6_step15_hf"
MAX_TURNS = 50
TEMPERATURE = 0.4
...
def main():
    ...
    print("\n" + "="*80)
    print("Per-Task-Type Breakdown (seed6 step15, 134 OOD)")
    print("="*80)
    ...
    save_path = "/data/tmp/seed6_step15_ood_eval.json"
